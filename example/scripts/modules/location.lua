...
if nship==0 or foundship==null or nship==1 and manager.foundship==foundship or nship==1 and manager:getshipscript(manager.foundship)==manager:findshipbymap(foundship.location) then
